...
class UserWatchedFilmsState {
  ...
  bool operator ==(Object other) =>
      ...
      (other is UserWatchedFilmsState &&
          runtimeType == other.runtimeType &&
          currentUserWatchedFilms == other.currentUserWatchedFilms);

  @override
  int get hashCode => currentUserWatchedFilms.hashCode;

  UserWatchedFilmsState copyWith({UserCurrentFilms? currentUserWatchedFilms}) {
    return UserWatchedFilmsState(
        currentUserWatchedFilms ?? this.currentUserWatchedFilms);
  }
}
...
class UserWatchedFilmsCubit extends Cubit<UserWatchedFilmsState> {
  ...
  UserWatchedFilmsCubit()
      : super(UserWatchedFilmsState(UserCurrentFilms(
            '', [CurrentFilm('', '', '', '', '', '', '', '')]))) {
    _initialize();
  }
