...
bool operator==(Object other)=>
    identical(this, other)||(other is UserStageFilmsState
    &&runtimeType==other.runtimeType && currentUserStageFilms==other.currentUserStageFilms
    );
...
return UserStageFilmsState(currentUserStageFilms??this.currentUserStageFilms);
...
class UserStageFilmsCubit extends Cubit<UserStageFilmsState>{
  ...
  UserStageFilmsCubit():super(UserStageFilmsState(UserStageFilms("", [Video("", "", "", "", "", "")]))){
    _initialize();
  }
