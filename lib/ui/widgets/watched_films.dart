  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UserWatchedFilmsState>(
        ...
        builder: (context, snapshot) {
          var watchedFilms =
              snapshot.data?.currentUserWatchedFilms.currentFilms;
                              ...
                              Container(
                                  ...
                                  child: FittedBox(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {},
                                      child: watchedFilms![index].poster != ''
                                          ? Image(
                                              image: AssetImage(
...
*/
                              ...
                              Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(watchedFilms![index].stateSpot,
                                        style: TextStyle(
                            ...
                            Text(watchedFilms![index].title,
                                style: TextStyle(
                                    fontSize: 14,
                                    color: Colors.white,
                                    fontWeight: FontWeight.w600)),
                            Text(
                                '${watchedFilms![index].seasonId} сезон ${watchedFilms![index].episodeId} серия',
                                style: TextStyle(
                                    fontSize: 14,
                                    color: Colors.white,
