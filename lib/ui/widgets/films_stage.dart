...
class _FilmsStageState extends State<FilmsStage> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> showIndicator(int positionImage){
      for(var i=0; i<cubit.state.currentUserStageFilms.stageFilms.length; i++) {
          ...
          indicator.add(
              Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(9), color:
                Colors.purple
                                      ...
                                      child: Container(
                                          ...
                                          FittedBox(
                                            ...
                                            GestureDetector(
                                              ...
                                              child:
                                              stageFilms![position].poster!=''?
                                              Image(
                                                  image:

                                                  AssetImage(stageFilms![position].poster)
                                              )
                                              /*CachedNetworkImage(
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            child: Text(textAlign: TextAlign.center, stageFilms![position].description, style:TextStyle(color:Colors.white, ))),
                                      ],
